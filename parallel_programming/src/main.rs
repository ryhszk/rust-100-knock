...
fn escape_time(c: Complex<f64>, limit: u32) -> Option<f32> {
...
fn test_parse_pair() {
    ...
    assert_eq!(parse_pair::<i32>("0.5x1.5", ','), Some((0.5, 1.5)));
}
    ...
    -> Complex<f64>
{
    ...
    Complex {
        ...
        // but the imaginary component increases as go up.
    }
}
...
/// `bounds`, to the file names `filename`.
